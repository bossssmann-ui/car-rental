        ...
        <div className="grid gap-12">
          ...
          <div role="button" tabIndex={0} className="bg-[#111] border border-white/10 p-10 rounded-3xl flex flex-col items-center gap-6 hover:border-[#D4AF37]/50 transition-colors cursor-pointer group">
            ...
            <div className="flex items-center gap-3 scale-150 transform origin-center my-4">
              <div className="relative w-10 h-10 flex items-center justify-center border border-[#D4AF37] rounded-sm bg-gradient-to-br from-[#1a1a1a] to-black group-hover:shadow-[0_0_20px_rgba(212,175,55,0.2)] transition-all">
                <span className="text-[#D4AF37] font-serif text-xl tracking-tighter absolute z-10">M</span>
                <span className="text-white/40 font-serif text-xl tracking-tighter absolute translate-x-[4px] translate-y-[4px]">V</span>
              </div>
              <div className="flex flex-col">
                <span className="text-white font-serif text-lg tracking-[0.2em] uppercase leading-none">Meridian</span>
          ...
          <div role="button" tabIndex={0} className="bg-[#111] border border-white/10 p-10 rounded-3xl flex flex-col items-center gap-6 hover:border-[#D4AF37]/50 transition-colors cursor-pointer group">
            ...
            <div className="flex items-center gap-1.5 scale-150 transform origin-center my-4">
              <span className="text-2xl font-light text-white tracking-widest">MERIDIAN</span>
              <Sparkles className="w-5 h-5 text-[#D4AF37] -mt-3 group-hover:animate-pulse" />
              <span className="text-2xl font-bold text-white tracking-widest">VL</span>
            </div>
          </div>
          ...
          <div role="button" tabIndex={0} className="bg-[#111] border border-white/10 p-10 rounded-3xl flex flex-col items-center gap-6 hover:border-[#D4AF37]/50 transition-colors cursor-pointer group">
            ...
            <div className="flex items-center gap-4 scale-150 transform origin-center my-4">
              <svg width="32" height="36" viewBox="0 0 32 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Логотип Meridian VL — щит" className="group-hover:drop-shadow-[0_0_10px_rgba(212,175,55,0.4)] transition-all">
              ...
              <div className="flex flex-col">
                <span className="text-white font-medium text-xl tracking-[0.15em] uppercase leading-none">Meridian VL</span>

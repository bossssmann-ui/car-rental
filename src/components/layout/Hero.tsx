...
// Zolotoy Rog (Golden Horn) bridge, Vladivostok at night
const BRIDGE_IMAGE_URL =
  'https://images.unsplash.com/photo-1572293125211-197e889d97b4?auto=format&fit=crop&q=80&w=2000';
    ...
    >
      ...
      >
        <img
          ...
          alt="Мост через бухту Золотой Рог, Владивосток"
        ...
        {/* Gold tint accent */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(212,175,55,0.10),transparent_70%)]" />
      </motion.div>
